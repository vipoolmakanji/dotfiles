# [RobinDSouza](https://github.com/RobinDSouza/dotfiles)’s dotfiles
...
| OS | Snippet |
|:---|:---|
| `macOS` | `bash -c "$(curl -LsS https://raw.github.com/RobinDSouza/dotfiles/master/src/os/setup.sh)"` |
| `Ubuntu` | `bash -c "$(wget -qO - https://raw.github.com/RobinDSouza/dotfiles/master/src/os/setup.sh)"` |
...
[license]: LICENSE.txt
[setup line]: https://github.com/RobinDSouza/dotfiles/blob/master/src/os/setup.sh
